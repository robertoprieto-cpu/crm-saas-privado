...
MASTER_KEY = os.environ.get("MASTER_KEY", "ADMIN_PROPIETARIO_2026_SECURE")

# ==========================================
# CONEXIÓN A GOOGLE Y SERVICIOS
# ==========================================
@st.cache_resource
def obtener_credenciales_google():
    """Carga credenciales desde st.secrets o archivo local."""
    ...
    if "gcp_service_account" in st.secrets:
        ...
        st.error("❌ No se encontraron las credenciales de Google.")
        st.stop()
